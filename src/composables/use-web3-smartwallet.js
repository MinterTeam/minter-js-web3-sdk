...
import smartWalletFactoryABI from '../abi/smartwallet-factory.js';
import smartWalletFactoryABILegacy from '../abi/smartwallet-factory-legacy.js';
...
export default function useWeb3SmartWallet() {
    ...
    async function preparePayload(txToList, txDataList, txValueList, overrideProps = {}) {
        ...
        return {
            ...
            // type: `send_to_${NETWORK_DATA[props.chainId].hubNetworkSlug}`,
        };
